...
const welcomeMsg = (name) =>
  ...
  `أهلاً *${name}* 👋\n\n` +
  `${SEP}\n\n` +
  `💡 *فكرة بسيطة، نتائج حقيقية:*\n` +
  `أودع رصيدك مرة واحدة، والنظام يتولى الباقي\n` +
  `تلقائياً على مدار الساعة — بدون أي خبرة مسبقة.\n\n` +
  `${SEP}\n\n` +
  `📈 *نسب الربح اليومية:*\n\n` +
  `┌ ⚡️ مبتدئ       › حتى *2.13٪*\n` +
  `├ 🔥 متوسط       › حتى *3.19٪*\n` +
  `├ 🌟 متقدم       › حتى *3.72٪*\n` +
  `└ 🚀 VIP         › حتى *4.25٪*\n\n` +
  `_الأرباح تُضاف كل 8 ساعات مباشرةً على رصيدك_\n\n` +
  `${SEP}\n\n` +
  `🚀 *ابدأ في 3 خطوات:*\n\n` +
  `1️⃣  أودع USDT عبر TRC20 أو BEP20\n` +
  `2️⃣  شغّل البوت من قائمة *حسابي*\n` +
  `3️⃣  استقبل أرباحك كل 8 ساعات 💰\n\n` +
  `${SEP}\n\n` +
...
const withdrawConfirmMsg = (withdrawal) =>
  ...
  `_سيتم معالجة طلبك خلال 2 إلى 7 أيام عمل._`;
